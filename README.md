...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/empty-cell-e292)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empty-cell-e292
```

A live public deployment of this template is available at [https://empty-cell-e292.templates.workers.dev](https://empty-cell-e292.templates.workers.dev)
